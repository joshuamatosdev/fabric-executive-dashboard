...
export const mockWidgets: WidgetInstance[] = [
  ...
  // Third Row Charts
  {
    id: widgetId('widget-bar-5'),
    dashboardId: dashboardId('dashboard-1'),
    config: {
      type: 'bar-chart',
      title: 'Recruiting vs Attrition',
  ...
  },
  {
    ...
    config: {
      ...
      xAxis: { dataKey: 'name' },
      series: [
        { dataKey: 'value', name: 'Revenue', color: '#ffb900', fillOpacity: 0.6 },
        { dataKey: 'value2', name: 'Expenses', color: '#0078d4', fillOpacity: 0.6 },
      ],
      showGrid: true,
      showTooltip: true,
    },
  ...
  {
    id: widgetId('widget-line-5'),
    dashboardId: dashboardId('dashboard-1'),
    config: {
      type: 'line-chart',
      title: 'Satisfaction Correlation',
      subtitle: 'Customer vs Employee',
      xAxis: { dataKey: 'name' },
      series: [
        {
          dataKey: 'value',
